# Contributing to UKIS_sat2h5

Welcome to `ukis_sat2h5`. We invite anyone to participate by contributing code, reporting bugs, fixing bugs, writing documentation or discussing the future of this project. As a contributor, here are the guidelines we would like you to follow:
...
Help us keep `ukis_sat2h5` open and inclusive. Please read and follow our [Code of Conduct](CODE_OF_CONDUCT.md).
